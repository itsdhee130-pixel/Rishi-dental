...
const testimonials = [
  {
    ...
    content: "The most high-tech medical experience I've ever had. The 3D visualization helped me understand exactly what was happening. Absolutely painless.",
    rating: 5,
  ...
  },
  {
    name: "Michael Chen",
    role: "Architect",
    content: "As a designer, I appreciate the attention to detail. The clinic feels more like a luxury lounge than a dentist. Dr. Rishi is a true artist.",
    rating: 5,
  ...
  },
  {
    name: "Priya Sharma",
    role: "Teacher",
    content: "I used to be terrified of dentists. This place changed everything. The calming atmosphere and gentle staff made me actually look forward to my visit.",
    rating: 5,
