        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            ...
            >
              ...
              >
                ...
                <div className="text-4xl font-bold text-medical-dark font-display mb-1">15+</div>
                <div className="text-sm text-gray-600 font-medium">Years of Clinical Excellence</div>
              </motion.div>
            </motion.div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              >
                <Award size={14} />
                <span>Chief Dentist & Founder</span>
              </motion.div>
              ...
              <p className="text-lg text-gray-500 font-body leading-relaxed">
                "I believe dentistry is a blend of art and engineering. My mission is to change the way you perceive dental care—moving from fear to comfort, and from treatment to transformation."
              </p>
            </motion.div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { icon: <GraduationCap />, title: "Gold Medalist", desc: "MDS - Conservative Dentistry" },
                { icon: <Users />, title: "5,000+ Smiles", desc: "Successfully Transformed" },
                { icon: <Award />, title: "Best Clinic Award", desc: "Awarded by Dental Guild 2023" },
                { icon: <CheckCircle2 />, title: "Advanced Cert.", desc: "Laser & Implant Dentistry" }
              ].map((item, i) => (
                <motion.div 
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
