    ...
    <footer className="bg-medical-dark text-white pt-20 pb-10">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/60 leading-relaxed">
              Redefining dental care with technology, compassion, and art. Your smile is our masterpiece.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              {['Cosmetic Dentistry', 'Dental Implants', 'Root Canal', 'Orthodontics', 'Teeth Whitening'].map(item => (
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              {['About Dr. Rishi', 'Patient Portal', 'Blog', 'Careers', 'Contact Us'].map(item => (
                <li key={item}><a href="#" className="hover:text-medical-light transition-colors">{item}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              <li className="flex gap-3 items-start">
                ...
                <span>123 Medical Park, Gomti Nagar,<br/>Lucknow, UP 226010</span>
              </li>
              ...
              <li className="flex gap-3 items-center">
                ...
                <span>care@rishidental.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-white/40 text-sm">
          <p>&copy; 2024 Rishi Dental Clinic. All rights reserved.</p>
